...
type Props = {
  categories: Category[];
  wallets: Wallet[];
  onSubmit: (data: z.infer<typeof expenseFormSchema>) => Promise<void>;
  onSaveAndAddMore?: (data: z.infer<typeof expenseFormSchema>) => Promise<void>;
};
...
export default function ExpenseForm({
  ...
  const form = useForm<z.infer<typeof expenseFormSchema>>({
    resolver: zodResolver(expenseFormSchema) as Resolver<
